...
video = pyorc.api.video.Video(video_file, start_frame=0, end_frame=1)  # we only need one frame
...
print(cam_config)
cam_config.to_file("ngwerere1.json")


cam_config = pyorc.load_camera_config("ngwerere1.json")
